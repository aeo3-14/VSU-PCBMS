...
<section class="vh-100">
    <div class="container py-5 h-100">
      ...
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="container">
            <img src='../Resources/img/vsu-logo.png'  class=" img-fluid rounded mx-auto d-block" alt="Phone image" height="90" width="380"/>
                    <h1 style="font-size:30px;text-align: center;margin-top:10px;color:#145A32">
                      Office of the Vice President for Research, Extension and Innovation</h1>
                      <h1 style="font-size: 40px; text-align: center;color: #0E6655">
                                    Pasalubong Center Business Management Web Application </h1>
         </div>   
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="../Resources/img/vsu-01.jpg" class="img-fluid" alt="Phone image" height="300px" width="600px">
        </div>
